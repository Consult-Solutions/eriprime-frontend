...
const ResetPassword: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            api.post<{ access_token: string }>('/auth/signin', { new_password: newPassword, confirm_password: confirmPassword }, {
                headers: {
                ...
                setLoading(false);
                setGlobalAlert('Password reset successfully.', 'success');
                navigate('/reset');
            }).catch((error) => {
                setLoading(false);
                    ...
                    <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                        ...
                        <div className='signup-form mt-5'>
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                />
                                {errors.new_password && <span className="text-red-600 text-sm">{errors.new_password}</span>}
                                ...
                                <AuthButton text="Submit Changes" isLoading={loading} type="submit" className="mt-5" />
                            </form>
                        </div>
                    </div>
                </div>
