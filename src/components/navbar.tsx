                ...
                <nav className="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div className="hidden lg:flex lg:items-center lg:ml-auto lg:space-x-10">
                        <Link to="/" title="" className="text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600 flex items-cente">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path opacity=".34" d="M12 18v-3" stroke="#697689" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10.07 2.82 3.14 8.37c-.78.62-1.28 1.93-1.11 2.91l1.33 7.96c.24 1.42 1.6 2.57 3.04 2.57h11.2c1.43 0 2.8-1.16 3.04-2.57l1.33-7.96c.16-.98-.34-2.29-1.11-2.91l-6.93-5.54c-1.07-.86-2.8-.86-3.86-.01Z" stroke="#697689" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                            </span>
                            <span className='ml-2'>
                                Home
                            </span>
                    ...
                    {isAuthenticated ? (<></>) : (<>
                        <Link to="/signup" className="inline-flex h-12 w-full items-center justify-center ml-10 rounded-full bg-[#03783d] px-6 font-medium tracking-wide text-white shadow-none outline-none transition duration-200 hover:bg-[#03783d] focus:ring sm:w-auto"> 
                    ...
                    {isAuthenticated ? (
                        <>
                            <button onClick={openModal} className="text-base font-medium mx-5 text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600 flex items-center">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path stroke="#697689" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.9 7.56c.31-3.6 2.16-5.07 6.21-5.07h.13c4.47 0 6.26 1.79 6.26 6.26v6.52c0 4.47-1.79 6.26-6.26 6.26h-.13c-4.02 0-5.87-1.45-6.2-4.99"></path><g opacity=".4"><path stroke="#697689" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 12H3.62M5.85 8.65L2.5 12l3.35 3.35"></path></g></svg>
                                </span>
