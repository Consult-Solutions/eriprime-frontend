...
function CTA() {
  return (<>
    <section className="bg-white rounded-3xl text-primary">
        <div className="flex flex-col items-center pr-10 py-12 mx-auto xl:flex-row justify-center">
            ...
            <div className="ml-5 md:ml-0 mt-5 md:mt-0">
                <h2 className="text-2xl font-semibold tracking-tight text-primary xl:text-4xl capitalize">
                    Connect with potential buyers & find your dream car today!
                </h2>

                <p className="block max-w-2xl mt-5 text-primary text-lg">
                ...
                <div className="mt-10 flex items-center">
                    <div className='hidden md:block'>
                        <Link to="/postcar" className="inline-flex h-11 w-full items-center justify-center text-sm rounded-full bg-secondary px-5 font-medium tracking-wide text-slate-700 shadow-none outline-none transition duration-200 hover:bg-secondary/80 focus:ring sm:w-auto border border-gray-200">
                    ...
                    <div className='hidden md:block'>
                        <Link to="/listings" className="inline-flex h-11 w-full items-center justify-center text-sm ml-10 rounded-full bg-secondary px-5 font-medium tracking-wide text-slate-700 shadow-none outline-none transition duration-200 hover:bg-secondary/80 focus:ring sm:w-auto border border-gray-200">
