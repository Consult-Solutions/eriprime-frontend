                ...
                <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200">
                        <ul className="pb-2 space-y-2 pt-3">
                            <li>
                                <NavLink to="/dashboard" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-[#03783d] group ${isActive ? 'bg-[#03783d]/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/cars" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-[#03783d] group ${isActive ? 'bg-[#03783d]/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/account" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-[#03783d] group ${isActive ? 'bg-[#03783d]/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/reports" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-[#03783d] group ${isActive ? 'bg-[#03783d]/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/users" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-[#03783d] group ${isActive ? 'bg-[#03783d]/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/activities" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-[#03783d] group ${isActive ? 'bg-[#03783d]/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/subscribers" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-[#03783d] group ${isActive ? 'bg-[#03783d]/70 text-white' : ''}`}>
