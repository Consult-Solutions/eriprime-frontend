                ...
                <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200">
                        <ul className="pb-2 space-y-2 pt-3">
                            <li>
                                <NavLink to="/dashboard" className={({ isActive }) => `flex items-center p-2 text-base font-bold text-slate-700 rounded-lg hover:bg-primary/50 hover:text-gray-100 group ${isActive ? 'bg-primary/80 text-white' : ''}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <path d="m9.02 2.838-5.39 4.2c-.9.7-1.63 2.19-1.63 3.32v7.41c0 2.32 1.89 4.22 4.21 4.22h11.58c2.32 0 4.21-1.9 4.21-4.21v-7.28c0-1.21-.81-2.76-1.8-3.45l-6.18-4.33c-1.4-.98-3.65-.93-5 .12Z" stroke="#697689" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path opacity=".34" d="M12 17.988v-3" stroke="#697689" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    <span className="ml-3">Overview</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/cars" className={({ isActive }) => `flex items-center p-2 text-base font-bold text-slate-700 rounded-lg hover:bg-primary/50 hover:text-gray-100 group ${isActive ? 'bg-primary/70 text-white' : ''}`}>
                            ...
                            {/* <li>
                                <NavLink to="/account" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-primary group ${isActive ? 'bg-primary/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/reports" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-primary group ${isActive ? 'bg-primary/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/users" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-primary group ${isActive ? 'bg-primary/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/activities" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-primary group ${isActive ? 'bg-primary/70 text-white' : ''}`}>
                            ...
                            <li>
                                <NavLink to="/subscribers" className={({ isActive }) => `flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-primary hover:text-primary group ${isActive ? 'bg-primary/70 text-white' : ''}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M16 2H8C4 2 2 4 2 8v13c0 .55.45 1 1 1h13c4 0 6-2 6-6V8c0-4-2-6-6-6Z" stroke="#697689" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M7 9.5h10M7 14.5h7" stroke="#697689" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path></svg>
