        ...
        <Link to={`/car/${car._id}`} className="overflow-hidden transition-shadow duration-300 bg-white rounded">
            <div className="overflow-hidden transition-shadow duration-300 bg-white rounded">
                <a href="/" aria-label="Article" className='relative'>
                    ...
                    {car.eco_friendly && (<div className="inline-flex absolute bottom-3 right-3 px-2 py-2 text-xs font-semibold tracking-widest rounded-full text-gray-100 bg-[#03783d]/90 mt-1"> 
                ...
                <div className="py-5">
                    <p className="mb-2 text-xs font-semibold text-gray-600 uppercase">
                        {car.make}, {car.car_model} - 3 Jul 2020
                    </p>                
                    ...
                    <p className="mb-4 text-slate-700"> {car.description } </p>
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div>
                            <Link to={`/cars/${car._id}`} className="inline-flex items-center justify-center rounded-full bg-[#03783d] px-3 py-1 font-medium text-sm tracking-wide text-white shadow-none outline-none transition duration-200 hover:bg-[#03783d] focus:ring sm:w-auto">
