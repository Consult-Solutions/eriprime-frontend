...
const Step2: React.FC<Step2Props> = ({ category, description, location, status, setCategory, setDescription, setLocation, setStatus }) => {
    ...
    return (
        <div>
            ...
            <TextAreaInput
                label="Description"
                placeholder="Write a brief description about your car"
                value={description}
