        ...
        <div className='mt-3'>
            ...
            <div className="mt-2.5 relative text-gray-400 focus-within:text-gray-600 transition-all duration-200">
                ...
                <select
                    ...
                    className={`block w-full py-4 pl-12 transition-all duration-200 border rounded-md focus:outline-none focus:border-blue-600 focus:bg-white caret-blue-600 ${errorMessage ? 'text-red-700 placeholder-red-500 border-red-200 bg-red-50' : 'text-black placeholder-gray-500 border-gray-200 bg-gray-50'}`}>
